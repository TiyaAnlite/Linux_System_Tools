...
###Disk mount tools###
===Version 1.3.1 Building===
Bash By | Tiya Anlite
This bash only run in Luninux
...
if is_bitlocker is True:
    ...
    init_sure = raw_input('Are you sure want to unlock and mount ' + str(mount_source) + ' to ' + str(mount_point) + ' ? (Y/N) ')
    if init_sure == 'y':
    ...
    init_sure = raw_input('Are you sure want to mount ' + str(mount_source) + ' to ' + str(mount_point) + ' ? (Y/N) ')
    if init_sure == 'y':
